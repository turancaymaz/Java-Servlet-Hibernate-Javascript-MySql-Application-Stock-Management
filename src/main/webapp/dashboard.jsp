        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="d-grid gap-2">
              <button onclick="location.href='http://localhost:8080/depo_project_war_exploded/customer.jsp'" class="btn btn-primary btn-lg mb-2 text-left custom_btn button1" type="button"> <i class="fas fa-user-plus"></i> Müşteri Ekle </button>
              <button onclick="location.href='http://localhost:8080/depo_project_war_exploded/products.jsp'"class="btn btn-warning btn-lg mb-2 text-left custom_btn button2" type="button"> <i class="fa fa-shopping-basket"></i> Ürün Ekle</button>
              <button onclick="location.href='http://localhost:8080/depo_project_war_exploded/boxAction.jsp'"class="btn btn-success btn-lg mb-2 text-left custom_btn button3" type="button"><i class="fa fa-shopping-cart"></i>  Sipariş Ekle</button>
              <button onclick="location.href='http://localhost:8080/depo_project_war_exploded/payIn.jsp'"class="btn btn-danger btn-lg mb-2 text-left  custom_btn button4" type="button"><i class="fa fa-window-maximize"></i> Ödeme Girişi</button>
            </div>
          </div>
          <div class="col-sm-6">
            ...
            >
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700; color:#22AE78;"><span><c:out value="${dbUtil.allCustomers().size()}"></c:out></span></div>
                </div>
              </div>
            </div>
            <div class="card mb-3">
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700; color: #244785;"><span><c:out value="${dbUtil.allReceipt().size()}"></c:out></span></div>
                </div>
              </div>
            </div>
            <div class="card mb-3">
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700;color: #F7B924;"><span><c:out value="${dbUtil.allProduct().size()}"></c:out></span></div>
                </div>
              </div>
            </div>
          </div>
