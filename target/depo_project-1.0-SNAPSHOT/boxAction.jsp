...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select id="pname" class="selectpicker" data-width="100%" data-show-subtext="true" data-live-search="true">
                        ...
                        <c:forEach items="${dbUtil.allProduct()}" var="item">
                            <option value="${item.p_id}" data-subtext="<c:out value="${item.p_salesPrice}Adet/KG Bulunmaktadır"></c:out>"><c:out value="${item.p_title}"></c:out></option>
                        </c:forEach>
                    </select>
                </div>
        ...
        <div class="btn-group col-md-3 " role="group">
            <button id="completeOrder" type="button" class="btn btn-outline-primary mr-1">Satışı Tamamla</button>
        </div>
